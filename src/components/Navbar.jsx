...
const Navbar = () => {
    ...
    return ( 
        <nav className="container flex justify-between items-center h-[100px]">
            {/* logo */}
            <div className="flex gap-1 sm:text-2xl mx-2 font-semibold">
            ...
            onSubmit={(e)=>e.preventDefault()}>
                ...
                <input type="text" 
                className="font-Khmer text-md w-[150px] sm:w-[400px] xl:w-[500px] px-8 py-2 rounded-md
                outline-none shadow-md hover:w-[200px] focus:w-[200px]
                hover:sm:w-[450px] focus:sm:w-[450px]
            ...
            <div className=" relative w-12 h-12 mx-2 rounded-md shadow-md bg-white flex justify-center items-center">
                <span className=" absolute font-bold -top-1 right-1 text-green-500">0</span>
